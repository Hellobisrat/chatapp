...
const ProfilePage = () => {
   ...
   const [bio,setBio]=useState("Hi Eveyone, I am Using QuickChat")
    ...
    justify-center'>
      ...
      rounded-lg'>
        <form onSubmit={handleSubmit} className='flex flex-col gap-5 p-10 flex-1 '>
          ...
          <img src={selectedImg ? URL.createObjectURL(selectedImg):assets.arrow_icon}  className={`w-12 h-12 ${selectedImg && 'rounded-full'}`} alt=""/>
